...
<
/a><a className="comment" onClick={this.props.onSelect}>评论&nbsp;{this.props.comment}</
a > < a;
;
className = "like" > 赞 & nbsp;
{
    this.props.like
}
<
/a><a className="dislike">踩&nbsp;{this.props.dislike}</
a > < / p >
</Col>
< Col;;
span = {4} > 图片 < / Col >
